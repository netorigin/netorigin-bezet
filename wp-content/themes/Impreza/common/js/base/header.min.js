!function($){"use strict";function USHeader(settings){this.settings=settings||{};this.state='default';this.$container=$us.$canvas.find('.l-header');if(this.$container.length==0){return}
